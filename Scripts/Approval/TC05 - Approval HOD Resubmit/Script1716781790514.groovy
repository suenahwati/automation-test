...
WebUI.selectOptionByValue(findTestObject('Page/Expenses-Claim-App/Approval/DropDown/dropdown_approval_status'), 'Resubmit', 
    false)

WebUI.setText(findTestObject('Page/Expenses-Claim-App/Approval/InputField/text_area_approver_remark'), 'Resubmit')
