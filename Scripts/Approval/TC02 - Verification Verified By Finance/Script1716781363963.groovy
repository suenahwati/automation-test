...
WebUI.selectOptionByValue(findTestObject('Page/Expenses-Claim-App/Approval/DropDown/dropdown_verify_status'), 'Verified by Finance', 
    false)

WebUI.setText(findTestObject('Page/Expenses-Claim-App/Approval/InputField/textarea_finance_remark'), 'ok verified')
