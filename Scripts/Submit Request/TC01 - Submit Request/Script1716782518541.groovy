...
WebUI.doubleClick(findTestObject('Page/Expenses-Claim-App/Request/Button/klik_purpose'))

WebUI.doubleClick(findTestObject('temp/td__current highlight'))

WebUI.setText(findTestObject('Page/Expenses-Claim-App/Request/InputField/set_purpose'), 'Claim Expenses')

WebUI.sendKeys(findTestObject('Page/Expenses-Claim-App/Request/InputField/set_purpose'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/temp/td__current highlight'))

WebUI.setText(findTestObject('Object Repository/temp/textarea_Transportation_handsontableInput'), '250000')

WebUI.setText(findTestObject('Object Repository/temp/input_Total Amount_total'), '0.00')
