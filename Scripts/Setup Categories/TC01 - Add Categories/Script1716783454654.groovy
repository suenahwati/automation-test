...
WebUI.click(findTestObject('Page/Expenses-Claim-App/Setup Categories/Button/btn_New'))

WebUI.setText(findTestObject('Page/Expenses-Claim-App/Setup Categories/InputField/input__Category'), 'Food')
