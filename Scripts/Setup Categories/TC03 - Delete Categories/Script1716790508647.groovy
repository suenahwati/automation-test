...
'Pemanggilan method login dengan variable global parameter username'
...
WebUI.click(findTestObject('Page/Expenses-Claim-App/Setup Categories/Button/btn_check_box'))

WebUI.delay(5)

WebUI.click(findTestObject('Page/Expenses-Claim-App/Setup Categories/Button/btn_Delete'))
